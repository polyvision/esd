...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Do. Dez 27 17:28:37 2012
# Project:  esd.pro
# Template: app
...
SOURCES       = src/main.cpp \
		...
		src/qlogger.cpp \
		src/psd_server.cpp moc_sound_engine.cpp \
		moc_qlogger.cpp \
		moc_psd_server.cpp
OBJECTS       = main.o \
		sound_engine.o \
...
esd.app/Contents/MacOS/libbass.dylib: /Users/ghostrifle/Dropbox/code/esd/libs/libbass.dylib
	@$(CHK_DIR_EXISTS) esd.app/Contents/MacOS || $(MKDIR) esd.app/Contents/MacOS 
	@$(DEL_FILE) esd.app/Contents/MacOS/libbass.dylib
	@$(COPY_FILE) /Users/ghostrifle/Dropbox/code/esd/libs/libbass.dylib esd.app/Contents/MacOS/libbass.dylib
dist: 
	@$(CHK_DIR_EXISTS) .tmp/esd1.0.0 || $(MKDIR) .tmp/esd1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/esd1.0.0/ && $(COPY_FILE) --parents inc/bass.h inc/sound_engine.h inc/app_settings.h inc/qlogger.h inc/psd_server.h .tmp/esd1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/sound_engine.cpp src/app_settings.cpp src/qlogger.cpp src/psd_server.cpp .tmp/esd1.0.0/ && (cd `dirname .tmp/esd1.0.0` && $(TAR) esd1.0.0.tar esd1.0.0 && $(COMPRESS) esd1.0.0.tar) && $(MOVE) `dirname .tmp/esd1.0.0`/esd1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/esd1.0.0
...
compiler_moc_header_make_all: moc_sound_engine.cpp moc_qlogger.cpp moc_psd_server.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_sound_engine.cpp moc_qlogger.cpp moc_psd_server.cpp
