...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Fri Feb 1 11:10:09 2013
# Project:  esd.pro
# Template: app
...
SOURCES       = src/main.cpp \
		...
		src/station_client.cpp moc_sound_engine.cpp \
		moc_qlogger.cpp \
		moc_psd_server.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/esd1.0.0/ && $(COPY_FILE) --parents inc/bass.h inc/sound_engine.h inc/app_settings.h inc/qlogger.h inc/psd_server.h inc/station_server.h inc/station_client.h .tmp/esd1.0.0/ && $(COPY_FILE) --parents src/main.cpp src/sound_engine.cpp src/app_settings.cpp src/qlogger.cpp src/psd_server.cpp src/station_server.cpp src/station_client.cpp .tmp/esd1.0.0/ && (cd `dirname .tmp/esd1.0.0` && $(TAR) esd1.0.0.tar esd1.0.0 && $(COMPRESS) esd1.0.0.tar) && $(MOVE) `dirname .tmp/esd1.0.0`/esd1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/esd1.0.0
...
compiler_moc_header_make_all: moc_sound_engine.cpp moc_qlogger.cpp moc_psd_server.cpp moc_station_server.cpp moc_station_client.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_sound_engine.cpp moc_qlogger.cpp moc_psd_server.cpp moc_station_server.cpp moc_station_client.cpp
